...
const styles = StyleSheet.create({
  dateSelectorContainer: { paddingHorizontal: SIZES.padding, paddingBottom: SIZES.padding*0.2, maxHeight: 100 },
  dateButton: { backgroundColor: COLORS.white, borderRadius: 25, paddingBottom: 10, paddingTop: 4, paddingHorizontal: 6, marginRight: 10, alignItems: 'center', justifyContent: 'space-between', minWidth: 54, minHeight: 75, borderWidth: 1, borderColor: '#E2E8F0' },
