...
import { UserPayload } from 'apps/account-service/src/domain/users/dtos/user.payload';
import { IRefreshTokenRepository } from 'apps/account-service/src/domain/users/interfaces/refresh-token.repository.interface';
...
export class TokenService {
    ...
    private async _generateRefreshToken(
        ...
        const refreshTokenEntity = this.refreshTokenRepo.create({
            token, deviceInfo, ipAddress, expiresAt, revoked: false,
        });
